    ...
    elseif(count($returnQueryGetCommande)==0){
        ...
        while ($iterateurCommande < count($returnQueryGetCommande)) {
            ...
            if ($nbProduit > 0) {
                ...
                echo '<input type="button" style ="border: 1px solid #305514; border-radius: 5px; padding: 5px; color: #305514" onclick="window.location.href=\'ViewMessagerie.php?Id_Interlocuteur=' . $idUti . '\'" value="' . $htmlEnvoyerMessage . '" class="btn btn-info mt-3">'; 
                echo '<br>';
